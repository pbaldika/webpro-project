        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/hotelroom.jpg)">
          <div class="carousel-container">
            <div class="container">
              ...
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Start Booking</a>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
          <div class="icon-box iconbox-blue">
            ...
            <h4><a href="">High Speed Internet Connection with VPN</a></h4>
            <p>We offer some of the fastest internet speeds and also a VPN which lets you mask your IP and encrypt your traffic.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box iconbox-orange ">
            ...
            <h4><a href="">Airport to hotel transportation</a></h4>
            <p>We offer transportation services from the airport straight to our hotels.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
          <div class="icon-box iconbox-pink">
            ...
            <h4><a href="">COVID-19 Tests</a></h4>
            <p>PCR tests are available for our guests in quarantine, with next day results. </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
          <div class="icon-box iconbox-yellow">
            ...
            <h4><a href="">Contactless Meal Service</a></h4>
            <p>Choose from a wide selection of dishes, delivered right to your doorstep.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box iconbox-red">
            ...
            <p>Our medical partners are standing right outside your door ready to assist in case of any medical emergency or needs</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="icon-box iconbox-teal">
            ...
            <h4><a href="">In Room Entertainment System</a></h4>
            <p>Choose from a selection of latest game consoles (PS5, Xbox) and multiple streaming services</p>
          </div>
        </div>
